...
public class WinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!sharedpreferences.getString("event","0").equals("solo")) {
            startActivity(new Intent(getApplicationContext(), GroupWinnerActivity.class));
            finish();
        }
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null) {
                    ...
                    startActivity(new Intent(WinnerActivity.this, LoginActivity.class));
                    finish();
                }
            }
        };
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                myRef.child(category).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        for(DataSnapshot rollNo:dataSnapshot.getChildren()) {
                            if (actvf.getText().toString().equals(rollNo.getKey())) {
                               Student st=rollNo.getValue(Student.class);
                                first.add(st);
                            }
                            else if(actvs.getText().toString().equals(rollNo.getKey())){
                                Student st=rollNo.getValue(Student.class);
                                first.add(st);
                            }
                        }
                ...
                if(first.size()>0) {
                    ...
                    myRef.child(sharedpreferences.getString("event", "0")).
                            ...
                            child("winners").child("first").setValue(first.get(0));
                    myRef.child(sharedpreferences.getString("event", "0")).
                            child(sharedpreferences.getString("subevent", "0")).
                            child(sharedpreferences.getString("subsubevent", "0")).
                            child(sharedpreferences.getString("finalsubevent", "0")).
                            child("winners").child("second").setValue(first.get(1));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_logout:
                ...
                return true;
            case R.id.menu_ce:
                startActivity(new Intent(WinnerActivity.this, WinnerSelectionActivity.class));
                finish();
                return true;
            default:
